...
This project undertakes to provide the hardware design for a DCC controlled LED PCB that can be used as a drop-in replacement for glowbulbs in the commonly used sizes.
